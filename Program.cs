...
namespace SimpleObjects
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var courseOOP = new Course("Fundamnetos OOP", "fundamentos-oop");
            var courseCsharp = new Course("Fundamnetos C#", "fundamentos-csharp");
            var courseAspNet = new Course("Fundamnetos APS.NET", "fundamentos-asp-net");
